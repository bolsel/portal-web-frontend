"use client";
import {UICarousel, UIContainer, UIIcon, UISwrComponent, UISwrComponentProps} from "@portal-web/shared-ui";
import {useResourceSWR} from "@portal-web/shared-api";
import clsx from "clsx";
import Link from "next/link";

export default function NewsListCarouselHeader({category}) {
  const swrData = useResourceSWR('news', {
    pathQuery: [category?'byCategorySlug':'latest', category],
    paramsQuery: {
      limit: 4
    }
  });
