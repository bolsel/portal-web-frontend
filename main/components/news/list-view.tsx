              ...
              <div className="w-full flex flex-col items-start justify-center">
                <Link href={`${pathRead}${item.slug}`}>
                  {titleComponent ? (
                    ...
                    <h2 className="text-base md:text-lg cursor-pointer font-lato font-medium text-neutral mb-2 group-hover:text-primary line-clamp-2">
                      {item.title}
                    </h2>
                  )}
                </Link>
