import LayoutTentangBolselPage from '../../components/layout/tentang-bolsel-page';
import Image from 'next/image';

export default function TentangBolselLambangDanMotoPage() {
  const maknaList = [
    {
  ...
  return (
    <LayoutTentangBolselPage page="logo-daerah">
      <section>
        <div className="mb-9">
          ...
          <p className=" leading-6 text-blue-gray-800 mb-8">
            Logo Daerah adalah panji kebesaran dan simbol kultural bagi
            masyarakat daerah yang mencerminkan kekhasan daerah Kabupaten
            Bolaang Mongondow Selatan dalam Negara Kesatuan Republik Indonesia
          </p>
          <p className=" leading-6 text-blue-gray-800 mb-8">
          ...
          <div
            className="relative w-full h-[344px] rounded-xl  bg-no-repeat bg-cover"
            style={{
              backgroundImage: 'url(/images/bg/jumbotron-default.jpeg)',
              backgroundSize: '100% 100%',
            }}
          >
            {/*<Image className='absolute w-full h-full' src={'/bg/jumbotron-default.jpeg'} alt={'a'} height={50} width={50}/>*/}
            <div
        ...
        <div className="mb-12 lg:mb-16">
          ...
          {/*    >*/}
          {/*    <div>*/}
          {/*      <p className="font-roboto font-bold text-green-700 mb-2">*/}
          {/*        {{ item.title }}*/}
          {/*      </p>*/}
          {/*      <p className="text-sm text-blue-gray-600 leading-6">*/}
          {/*        {{ item.description }}*/}
          {/*      </p>*/}
          {/*    </div>*/}
          {/*    <div className="h-12 md:h-28 flex justify-start md:justify-center items-center flex-shrink-0 mb-4 md:mb-0">*/}
          {/*      <Icon*/}
          {/*      :src="item.icon"*/}
          {/*      :alt="item.title"*/}
          {/*      />*/}
