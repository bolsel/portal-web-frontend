...
import UIBaseIconDocument from '../../icon/icons/document';

export type UIBaseViewDocumentListItemType<Item extends Record<string, any>> =
  IUIBaseCreateCustomizableDefine<
    {
      skeleton?: boolean;
      item: Item;
  ...
  >;
export const UIBaseViewDocumentListItem = <Item extends Record<string, any>>(
  props: UIBaseViewDocumentListItemType<Item>['props']
) => {
  return UIBaseCreateCustomizable<UIBaseViewDocumentListItemType<Item>>({
    props,
    defaults: {
      small: () => false,
      hideCategory: () => false,
