...
export type UIViewApplicationWidgetListType = IUIBaseCreateCustomizableDefine<
  RequireOnlyOne<Props, 'items' | 'skeleton'> & { swiper?: SwiperProps }
>;
export const UIViewApplicationWidgetList: UIViewApplicationWidgetListType['returnType'] =
  (props) =>
    UIBaseCreateCustomizable<UIViewApplicationWidgetListType>({
      props,
      defaults: {},
...
group-hover:text-primary-700 group-hover:bg-primary-200"
                    ...
                    {item.link ? (
                      <div className="flex-1 flex items-end">
                        ...
                        >
                          Buka Aplikasi <UIBaseIcon icon="external-link" />
                        </Link>
                      </div>
                    ) : null}
                  </div>
