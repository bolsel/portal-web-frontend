...
export type UIModalType = IUIBaseCreateCustomizableDefine<
  {
    show: boolean;
...
export function useUIModalShowState(show: boolean) {
  return useState<boolean>(show);
}
export const UIModal: UIModalType['returnType'] = (props) =>
  UIBaseCreateCustomizable<UIModalType>({
    props,
    defaults: {
    ...
    Component({ show, setShow, children, render }) {
