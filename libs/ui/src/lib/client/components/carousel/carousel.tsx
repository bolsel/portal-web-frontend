...
export type UICarouselType<I extends Record<string, any>> =
  ...
  >;
export const UICarousel = <I extends Record<string, any>>(
  props: UICarouselType<I>['props']
) => {
  return UIBaseCreateCustomizable<UICarouselType<I>>({
    props,
    defaults: {
      autoPlay: () => true,
      pauseOnHover: () => true,
      ...
      Component({ render }) {
        return ({ currentIndex, items, next, prev, setCurrentIndex }) => {
