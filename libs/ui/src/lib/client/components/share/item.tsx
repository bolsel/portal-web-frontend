  ...
  const networks: any = [
    {
      ...
      icon: (
        <UIBaseIcon icon="logo-color-facebook" inline className="w-6 h-6" />
      ),
    ...
    },
    {
      ...
      icon: <UIBaseIcon icon="logo-color-twitter" inline className="w-6 h-6" />,
      props: () => ({
        title,
        quote,
    ...
    },
    {
      ...
      icon: (
        <UIBaseIcon icon="logo-color-whatsapp" inline className="w-6 h-6" />
      ),
      props: () => ({ title, quote }),
    },
    {
      ...
      icon: (
        <UIBaseIcon icon="logo-color-telegram" inline className="w-6 h-6" />
      ),
      props: () => ({ title, quote }),
    },
    {
      ...
      icon: (
        <UIBaseIcon icon="mail" color="#E53935" inline className="w-6 h-6" />
      ),
