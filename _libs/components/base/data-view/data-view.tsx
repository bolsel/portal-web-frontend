...
export type LibBaseDataViewProps = {
  children: ReactElement | ((props: Omit<LibBaseDataViewProps, 'children'>) => any)
...
export default function LibBaseDataView(
  ...
  return <div className="w-full">
    ...
    {!hideViewSwitch && <div className="flex min-w-0 gap-4 justify-end divide-x divide-gray-400">
