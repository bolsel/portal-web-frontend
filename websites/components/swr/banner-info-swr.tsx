...
export default function BannerInfoSwr() {
  ...
  const loadingComponent = () => (
    <div className="mb-5 bg-base-200 animate-pulse w-full h-[240px] rounded-lg"></div>
  );
  const noItemsComponent = () => (
    <div className="mb-5 bg-base-200 w-full h-full rounded-lg flex justify-center items-center">
