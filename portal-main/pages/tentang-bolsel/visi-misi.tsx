...
// const LayoutTentangBolselPage = dynamic(() => import('../../components/layouts/tentang-bolsel-page'), {
//   ssr: false,
// })

export default function TentangBolselPage() {
  return (
    <LayoutTentangBolselPage page="visi-misi">
      <section>
        ...
        <div className="bg-gray-100 p-4 md:p-6 lg:p-8 rounded-2xl mb-8">
          ...
          <ol className="list-decimal px-4 md:px-10">
            <li>
              Meningkatkan Nilai - Nilai Religius dan Bersatu Memelihara
              Toleransi Antar Umat Beragama Yang Berkearifan Lokal Berdasarkan
              Pancasila.
            </li>
