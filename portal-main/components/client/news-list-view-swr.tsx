...
export const NewsListViewSwr: FC<Omit<NewsListViewProps, 'items'> & {
  ...
  const LoadingComponent = () => {
    ...
    return <div className="flex-auto w-full flex flex-col gap-5 md:gap-6">{items}</div>;
  }
  ...
  return <NewsListView
    ...
    pagination={noPagination ? undefined : data && data.meta ? {
      setPage,
      setLimit,
      limit,
      page,
